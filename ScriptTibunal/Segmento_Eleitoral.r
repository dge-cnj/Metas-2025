...
# 16/06/2025 - Validação da versão paralela para os TRE's
...
Eleitoral.Meta02 <- function(dge) {
    ...
    t_f <- "2026-01-01"
    t_0 <- "2025-01-01" # Início do ano
    t_ant <- "2020-01-01" # Para englobar todo o período de 2019
    t_rec <- "2024-01-01" # Recebimento
