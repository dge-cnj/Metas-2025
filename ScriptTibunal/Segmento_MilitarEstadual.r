...
# 1 - 03/06/2025 (Ajuste no cálculo da meta 2 para os processos antigos)

# Meta 2 de 2025 – Julgar processos mais antigos
# Identificar e julgar, até 31/12/2025, todos os processos de conhecimento pendentes de julgamento há 3 anos (2022) ou mais e 90% dos processos distribuídos até 31/12/2023 nas Auditorias e 95% dos processos distribuídos até 31/12/2024 no 2º Grau.

MilitarEstadual.Meta02 <- function(dge) {

    
    t_f <- "2026-01-01" # Relativo ao final do período
    t_aud <- "2024-01-01"
    t_seg <- "2025-01-01"
    t_ant <- "2023-01-01"
