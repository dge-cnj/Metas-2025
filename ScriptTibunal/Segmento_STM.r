...
# 16/09/2025: Validação da versão paralelizada.
...
STM.Meta02 <- function(dge) {
    ...
    t_0 <- "2025-01-01" # Início do período (usado também para os processos mais antigos)
    t_f <- "2026-01-01" # Final do período de cômputo da meta 02
    t_dist <- "2023-01-01" # Data de corte para um processo ser considerado na meta 02
    t_rec <- "2021-01-01"
    t_sup <- "2024-01-01"
